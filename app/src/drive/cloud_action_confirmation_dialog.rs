...
impl CloudActionConfirmationDialog {
    ...
    fn body_text(&self) -> String {
        match self.variant {
            CloudActionConfirmationDialogVariant::LeaveTeam => tr("cloud_action.leave_team_body"),
            CloudActionConfirmationDialogVariant::DeleteTeam => tr("cloud_action.delete_team_body"),
            CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                tr("cloud_action.leave_team_reload_credits_body")
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                tr("cloud_action.remove_team_member_reload_credits_body")
            }
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
    ...
    fn confirm_button_text(&self) -> String {
        match self.variant {
            CloudActionConfirmationDialogVariant::LeaveTeam => {
                tr("cloud_action.leave_team_confirm")
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                tr("cloud_action.delete_team_confirm")
            }
            CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                tr("settings.teams.leave_team")
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                tr("cloud_action.remove_member")
            }
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
