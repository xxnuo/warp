...
impl RewardView {
    ...
    fn subtitle(&self) -> String {
        match self.kind {
            RewardKind::SentReferralTheme => tr("reward.sent_referral_theme"),
            RewardKind::ReceivedReferralTheme => tr("reward.received_referral_theme"),
        }
    }
        ...
        Align::new(
            Container::new(
                ui_builder
                    ...
                    .with_centered_text_label(tr("reward.try_it_out"))
                    .with_style(UiComponentStyles {
...
impl View for RewardView {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            format!("{} {}", tr("reward.title"), self.subtitle()),
            tr("reward.accessibility_help"),
