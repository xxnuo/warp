...
impl EnvVarCollectionView {
    ...
    pub(super) fn render_trash_banner(
        ...
        let text = if deleted {
            tr("env_vars.trash_banner.no_access")
        } else {
            tr("env_vars.trash_banner.moved_to_trash")
        };
        stack.add_child(
            Align::new(
                Flex::row()
                ...
                action_row.add_child(
                    Align::new(
                        appearance
                            ...
                            .with_tooltip(move || {
                                ui_builder
                                    .tool_tip(tr("env_vars.trash_banner.restore_tooltip"))
                                    .build()
                                    .finish()
                            })
    ...
    pub(super) fn render_save_button(
        ...
        let mut button = appearance
            ...
            .with_centered_text_label(tr("common.save"));
