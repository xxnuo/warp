    ...
    A: Action + Clone,
{
    ...
    let text = tr("auth.offline.first_time_required");
    ...
    let button = ui_builder
        ...
        .with_centered_text_label(tr("common.learn_more"))
        .build()
    ...
    A: Action + Clone,
{
    ...
    let paragraph_1 = tr("auth.offline.paragraph_1");
    let paragraph_2 = tr("auth.offline.paragraph_2");
    let paragraph_3 = tr("auth.offline.paragraph_3");
...
pub fn render_privacy_settings_toggles<A: Action + Clone + 'static>(
    ...
    let telemetry_description =
        render_description(appearance, tr("auth.privacy.telemetry_description"));
    ...
    let crash_reporting_description =
        render_description(appearance, tr("auth.privacy.crash_reporting_description"));
    ...
    let cloud_conversation_storage_description = render_description(
        ...
        if PrivacySettings::as_ref(app).is_cloud_conversation_storage_enabled {
            tr("auth.privacy.cloud_conversation_storage_enabled")
        } else {
            tr("auth.privacy.cloud_conversation_storage_disabled")
        },
    );
