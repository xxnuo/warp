...
pub fn render_agent_mode_setup_banner(
    ...
    let open_button = InlineBannerTextButton {
        text: tr("terminal.inline_banner.agent_mode_setup.optimize"),
    ...
    render_inline_block_list_banner(
        ...
        appearance,
        InlineBannerContent {
            title: tr("terminal.inline_banner.agent_mode_setup.title"),
            ...
            content: Some(vec![Text::new(
                tr("terminal.inline_banner.agent_mode_setup.text"),
