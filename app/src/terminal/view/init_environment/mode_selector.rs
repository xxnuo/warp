...
impl EnvironmentSetupModeSelector {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = Text::new(
            tr("terminal.init_environment.choose_setup"),
        ...
        Hoverable::new(mouse_state, move |state| {
            ...
            if is_suggested {
                let suggested_text = Text::new(
                    tr("settings.environments.suggested"),
                    font_family,
    ...
    fn render_modal(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let remote_github_option = self.render_option(
            0,
            Icon::Github,
            tr("terminal.init_environment.quick_setup"),
            tr("terminal.init_environment.quick_setup_description"),
            true,
        ...
        let local_repos_option = self.render_option(
            1,
            Icon::Terminal,
            tr("terminal.init_environment.use_agent"),
            tr("terminal.init_environment.use_agent_description"),
            false,
