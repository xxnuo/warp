...
impl WorkflowsMoreInfoView {
    ...
    fn render_edit_button(
        ...
        let label = if cloud_workflow.model().data.is_agent_mode_workflow() {
            tr("workflows.info_box.edit_prompt")
        } else {
            tr("workflows.info_box.edit_workflow")
        };
    ...
    fn render_command_edited_menu(&self, appearance: &Appearance) -> Box<dyn Element> {
        let contents = Flex::row()
            ...
            .with_child(
                Container::new(
                    Text::new_inline(
                        tr("workflows.info_box.command_edited"),
                        appearance.ui_font_family(),
            ...
            .with_child(
                appearance
                    ...
                    .with_centered_text_label(tr("workflows.info_box.reset"))
                    .with_style(UiComponentStyles {
                        font_family_id: Some(appearance.ui_font_family()),
                        font_size: Some(appearance.monospace_font_size()),
        ...
        let cycle_parameter_text = Flex::row()
            ...
            .with_child(
                Shrinkable::new(
                    ...
                    Container::new(
                        Text::new_inline(
                            tr("workflows.info_box.cycle_parameters"),
                            appearance.ui_font_family(),
                            appearance.monospace_font_size(),
                        )
                        .with_color(
    ...
    fn render_save_workflow_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        render_hoverable_card_button(
            icons::Icon::Workflow,
            Some(tr("terminal.block_list.save_as_workflow")),
                ...
                ConstrainedBox::new(
                    appearance
                        ...
                        .with_centered_text_label(tr(
                            "workflows.info_box.new_environment_variables",
                        ))
                        .build()
                        .on_click(|ctx, _, _| {
    ...
    fn render_workflow_source(
        ...
        Container::new(
            appearance
                .ui_builder()
                .link(
                    tr("workflows.info_box.view_context"),
