...
impl PrivacyPageView {
    ...
    pub fn new(ctx: &mut ViewContext<PrivacyPageView>) -> Self {
        ...
        let add_regex_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(tr("settings.privacy.add_regex_pattern_title")),
                add_regex_body,
                ctx,
            )
    ...
    fn build_page() -> PageType<Self> {
        ...
        PageType::new_uncategorized(widgets, Some(tr("settings.section.privacy")))
    }
...
impl SecretRedactionWidget {
    ...
    fn render_tab_bar(
        ...
        let enterprise_tab = self.render_tab(
            tr("settings.privacy.enterprise"),
            enterprise_count,
        ...
        if is_enterprise_tab_active {
            ...
            row.add_child(self.render_info(
                tr("settings.privacy.enterprise_secret_redaction_locked"),
                appearance,
            ));
        }
    ...
    fn render_enterprise_content(
        ...
        if enterprise_regex_list.is_empty() {
            return ui_builder
                .paragraph(tr("settings.privacy.no_enterprise_regexes"))
                .with_style(UiComponentStyles {
                    font_color: Some(description_text_color),
                    ..Default::default()
                })
            ...
            column.add_child(
                Container::new(
                    Flex::row()
                        ...
                        .with_cross_axis_alignment(CrossAxisAlignment::Center)
                        .with_child(self.render_section_title(tr("common.recommended"), appearance))
                        .with_child(
                            Container::new(
                                ui_builder
                                    .button(
...
impl SettingsWidget for SecretRedactionWidget {
    ...
    fn render(
            ...
            Flex::row()
                .with_child(
                    Shrinkable::new(
                        ...
                        render_sub_header(
                            appearance,
                            tr("settings.privacy.secret_redaction"),
                ...
                .with_child(
                    Container::new({
                        if is_enterprise_enabled {
                            self.render_info(
                                tr("settings.privacy.enabled_by_organization"),
                                appearance,
                            )
                        } else {
                            ui_builder
        ...
        let mut column = Flex::column()
            ...
            .with_child(
                ui_builder
                    .paragraph(tr("settings.privacy.secret_redaction_description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
        ...
        if *safe_mode_settings.safe_mode_enabled {
            ...
            let label_with_icon = super::settings_page::render_dropdown_item_label(
                tr("settings.privacy.secret_visual_redaction_mode"),
                None,
            ...
            let left_content = Flex::column()
                ...
                .with_child(
                    Container::new(
                        ui_builder
                            .paragraph(tr("settings.privacy.secret_visual_redaction_description"))
                            .with_style(UiComponentStyles {
                                font_color: Some(description_text_color),
                        ...
                        Expanded::new(
                            ...
                            Flex::column()
                                .with_child(self.render_section_title(
                                    tr("settings.privacy.custom_secret_redaction"),
                                    appearance,
                                ))
                                .with_child(self.render_description(
                                    tr("settings.privacy.custom_secret_redaction_description"),
                                    appearance,
...
impl AppAnalyticsWidget {
    fn render_zero_data_retention_badge(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Hoverable::new(self.zdr_badge_mouse_state.clone(), move |mouse_state| {
            ...
            if is_hovered {
                let tooltip = ui_builder.tool_tip(tr("settings.privacy.zdr_tooltip"));
...
impl SettingsWidget for AppAnalyticsWidget {
    ...
    fn render(
        ...
        let description = if is_enterprise {
            tr("settings.privacy.telemetry_description_old")
        } else {
            tr("auth.privacy.telemetry_description")
        };
        ...
        let zdr_label_component = if self.should_show_zdr_badge(app) {
            Flex::row()
                ...
                .with_child(render_body_item_label::<PrivacyPageAction>(
                    tr("auth.privacy.help_improve_warp"),
                    None,
                    None,
        ...
        let switch = if is_toggleable {
            ...
            switch
                .with_tooltip(TooltipConfig {
                    text: tr("settings.privacy.managed_by_organization"),
        ...
        if !is_on_paid_plan {
            column.add_child(
                ui_builder
                    .paragraph(tr("settings.privacy.free_tier_analytics_note"))
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
                        margin: Some(
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        tr("settings.privacy.read_more_data_use"),
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                tr("auth.privacy.send_crash_reports"),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(tr("auth.privacy.crash_reporting_description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
...
impl SettingsWidget for CloudConversationStorageWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                tr("auth.privacy.store_ai_conversations"),
                None,
                LocalOnlyIconState::Hidden,
                toggle_state,
                appearance,
...
impl SettingsWidget for NetworkLogWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                tr("settings.privacy.network_log_console"),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(tr("settings.privacy.network_log_console_description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
            ...
            .with_child(
                Align::new(
                    ui_builder
                        .link(
                            tr("settings.privacy.view_network_logging"),
                            None,
                            Some(Box::new(|ctx| {
...
impl SettingsWidget for DataManagementWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                tr("settings.privacy.data_management"),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                ui_builder
                    .paragraph(tr("settings.privacy.data_management_description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            tr("settings.privacy.data_management_link"),
                            None,
                            Some(Box::new(|ctx| {
                                ctx.dispatch_typed_action(
                                    PrivacyPageAction::OpenDataManagementWebpage,
...
impl SettingsWidget for PrivacyPolicyWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                tr("settings.privacy.privacy_policy"),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            tr("settings.privacy.privacy_policy_link"),
