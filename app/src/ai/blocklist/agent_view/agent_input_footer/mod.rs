...
impl AgentInputFooter {
    ...
    pub fn new(
        ...
        let nld_button = ctx.add_typed_action_view(|ctx| {
            ...
            button.set_tooltip(
                Some(if is_nld_enabled {
                    tr("agent_input_footer.disable_nld_tooltip")
                } else {
                    tr("agent_input_footer.enable_nld_tooltip")
                }),
                ctx,
            );
            button
        ...
        let fast_forward_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("", FastForwardButtonTheme)
                ...
                .with_tooltip(tr("ai_block.fast_forward_off_tooltip"))
                .with_size(button_size)
                .with_tooltip_alignment(TooltipAlignment::Left)
        ...
        let handoff_to_cloud_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("", AgentInputButtonTheme)
                ...
                .with_tooltip(tr("agent_input_footer.hand_off_to_cloud_tooltip"))
                .with_size(button_size)
                .with_tooltip_alignment(TooltipAlignment::Left)
                .on_click(|ctx| {
        ...
        let file_explorer_button = ctx.add_typed_action_view(|ctx| {
            ActionButton::new(
                tr("agent_input_footer.file_explorer"),
                AgentInputButtonTheme,
            )
            .with_icon(Icon::FileCopy)
            .with_tooltip(tr("agent_input_footer.open_file_explorer"))
        ...
        let rich_input_button = ctx.add_typed_action_view(|ctx| {
            ActionButton::new(tr("agent_input_footer.rich_input"), AgentInputButtonTheme)
                .with_icon(Icon::TextInput)
                .with_tooltip(tr("agent_input_footer.open_rich_input"))
                .with_size(cli_button_size)
                .with_tooltip_alignment(TooltipAlignment::Left)
                .with_keybinding(
        ...
        let settings_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("", AgentInputButtonTheme)
                ...
                .with_tooltip(tr("agent_input_footer.open_coding_agent_settings"))
                .with_size(cli_button_size)
                .with_tooltip_alignment(TooltipAlignment::Left)
                .on_click(|ctx| {
        ...
        let install_plugin_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(
                tr("agent_input_footer.enable_notifications"),
                InstallPluginButtonTheme,
            )
            .with_icon(Icon::Download)
            .with_tooltip(tr("agent_input_footer.install_plugin_tooltip"))
            .with_size(cli_button_size)
            .with_tooltip_alignment(TooltipAlignment::Left)
        ...
        let plugin_instructions_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(
                tr("agent_input_footer.notifications_setup_instructions"),
                InstallPluginButtonTheme,
            )
            .with_icon(Icon::Info)
            .with_tooltip(tr("agent_input_footer.view_install_plugin_instructions"))
            .with_size(cli_button_size)
            .with_tooltip_alignment(TooltipAlignment::Left)
            .with_adjoined_side(AdjoinedSide::Right)
            .on_click(|ctx| {
        ...
        let update_plugin_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(
                tr("agent_input_footer.update_warp_plugin"),
                InstallPluginButtonTheme,
            )
            .with_icon(Icon::Download)
            .with_tooltip(tr("agent_input_footer.update_plugin_available"))
            .with_size(cli_button_size)
            .with_tooltip_alignment(TooltipAlignment::Left)
            .with_adjoined_side(AdjoinedSide::Right)
            .on_click(|ctx| {
        ...
        let update_instructions_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(
                tr("agent_input_footer.plugin_update_instructions"),
                InstallPluginButtonTheme,
            )
            .with_icon(Icon::Info)
            .with_tooltip(tr("agent_input_footer.view_update_plugin_instructions"))
            .with_size(cli_button_size)
            .with_tooltip_alignment(TooltipAlignment::Left)
            .with_adjoined_side(AdjoinedSide::Right)
            .on_click(|ctx| {
        ...
        let dismiss_plugin_chip_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("", InstallPluginButtonTheme)
                .with_icon(Icon::X)
                .with_size(cli_button_size)
                .with_tooltip(tr("common.dismiss"))
                .with_tooltip_alignment(TooltipAlignment::Left)
            ...
            move |me, _, event, ctx| {
                ...
                if let CLIAgentSessionsModelEvent::Started { .. } = event {
                    if let Some(agent) = me.cli_agent(ctx) {
                        let label = tr_with(
                            "agent_input_footer.enable_agent_notifications",
                ...
                me.rich_input_button.update(ctx, |button, ctx| {
                    if is_open {
                        button.set_label(tr("agent_input_footer.hide_rich_input"), ctx);
                        button.set_tooltip(Some(tr("agent_input_footer.hide_rich_input")), ctx);
                        ...
                        button.set_label(tr("agent_input_footer.rich_input"), ctx);
                        button.set_tooltip(Some(tr("agent_input_footer.open_rich_input")), ctx);
                        button.set_keybinding(
                            Some(KeystrokeSource::Binding(
                                OPEN_CLI_AGENT_RICH_INPUT_KEYBINDING,
                            )),
        ...
        let start_remote_control_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("/remote-control", RemoteControlButtonTheme)
                ...
                .with_tooltip(tr("agent_input_footer.start_remote_control"))
                .with_size(cli_button_size)
                .with_tooltip_alignment(TooltipAlignment::Left)
                .on_click(|ctx| {
        ...
        let context_window_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("", AgentInputButtonTheme)
                ...
                .with_tooltip(tr("agent_input_footer.context_window_usage"))
                .with_size(button_size)
                .with_tooltip_alignment(TooltipAlignment::Left)
        });
        ...
        ctx.spawn(
            async move {
                ...
                let Some(manager) =
                    ...
                    return Err((
                        PluginInstallError {
                            message: tr("agent_input_footer.no_plugin_manager_available"),
                            log: String::new(),
                        },
                        None,
                    ));
                        ...
                        Err((err, log_path)) => {
                            ...
                            if let Some(log_path) = log_path {
                                toast = toast.with_link(
                                    ToastLink::new(tr("agent_input_footer.see_logs_for_details"))
    ...
    fn handle_install_plugin(&mut self, ctx: &mut ViewContext<Self>) -> bool {
        let success_msg = self
            ...
            .unwrap_or_else(|| tr("agent_input_footer.plugin_installed_restart"));
        self.handle_plugin_operation(
            tr("agent_input_footer.installing_warp_plugin"),
            tr("agent_input_footer.failed_install_warp_plugin"),
            success_msg,
    ...
    fn handle_update_plugin(&mut self, ctx: &mut ViewContext<Self>) -> bool {
        let success_msg = self
            ...
            .unwrap_or_else(|| tr("agent_input_footer.plugin_updated_restart"));
        self.handle_plugin_operation(
            tr("agent_input_footer.updating_warp_plugin"),
            tr("agent_input_footer.failed_update_warp_plugin"),
            success_msg,
            ...
            CLIVoiceInputState::Stopped => {
                if !crate::ai::AIRequestUsageModel::as_ref(ctx).can_request_voice() {
                    self.show_cli_voice_error_toast(
                        tr("agent_input_footer.voice_input_limit_reached"),
                        ctx,
                    );
                    return;
                }
        ...
        match result {
            ...
            Err(e) => match e {
                ...
                _ => {
                    ...
                    self.show_cli_voice_error_toast(
                        tr("agent_input_footer.failed_transcribe_voice_input"),
                        ctx,
                    );
                }
            },
    ...
    #[cfg(feature = "voice_input")]
    fn show_cli_voice_error_toast(&self, message: impl Into<String>, ctx: &mut ViewContext<Self>) {
        let window_id = ctx.window_id();
        ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
            let toast = DismissibleToast::error(message.into());
    ...
    fn show_cli_microphone_access_toast(&self, ctx: &mut ViewContext<Self>) {
        let window_id = ctx.window_id();
        ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
            let toast = DismissibleToast::error(tr("agent_input_footer.failed_start_voice_input"));
            toast_stack.add_ephemeral_toast(toast, window_id, ctx);
        });
    }
    ...
    fn maybe_show_first_time_cli_voice_toast(&self, ctx: &mut ViewContext<Self>) {
        ...
        AISettings::handle(ctx).update(ctx, |settings, ctx| {
            if let Some(toggle_key) = settings.maybe_setup_first_time_voice(ctx) {
                ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = DismissibleToast::success(tr_with(
                        "agent_input_footer.voice_input_enabled_toast",
    ...
    fn sync_fast_forward_button(&self, ctx: &mut ViewContext<Self>) {
        ...
        let tooltip = if is_force_enabled {
            tr("ai_block.fast_forward_locked_tooltip")
        } else if is_active {
            tr("ai_block.fast_forward_on_tooltip")
        } else {
            tr("ai_block.fast_forward_off_tooltip")
        };
    ...
    fn sync_remote_control_button(&self, ctx: &mut ViewContext<Self>) {
        ...
        let tooltip = if login_required {
            tr("agent_input_footer.start_remote_control_login_required")
        } else {
            tr("agent_input_footer.start_remote_control")
        };
    ...
    fn update_context_window_button(&mut self, ctx: &mut ViewContext<Self>) {
            ...
            BlocklistAIHistoryModel::as_ref(ctx).active_conversation(self.terminal_view_id)
        {
            ...
            let tooltip = tr_with(
                "agent_input_footer.context_remaining",
            ...
            Flex::row()
                ...
                .with_child(
                    Expanded::new(
                        1.,
                        Text::new(
                            tr("agent_input_footer.using_full_terminal_agent_default_model"),
