...
impl CustomizeUISlide {
    ...
    fn render_tab_styling_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: tr("onboarding.customize.tab_styling"),
                is_expanded: is_selected,
                is_left_selected: ui.use_vertical_tabs,
                left_label: tr("common.vertical"),
                right_label: tr("common.horizontal"),
    ...
    fn render_tools_panel_card(
        ...
        if ui.tools_panel_enabled(&intention) {
            chips.push(ChipSpec {
                label: tr("onboarding.customize.file_explorer"),
            ...
            if is_agent {
                chips.push(ChipSpec {
                    label: tr("onboarding.customize.conversation_history"),
            ...
            chips.push(ChipSpec {
                label: tr("onboarding.customize.global_file_search"),
            ...
            chips.push(ChipSpec {
                label: tr("onboarding.feature.warp_drive"),
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: tr("onboarding.customize.tools_panel.title"),
                is_expanded: is_selected,
                is_left_selected: ui.tools_panel_enabled(&intention),
                left_label: tr("common.enabled"),
                right_label: tr("common.disabled"),
    ...
    fn render_code_review_card(
        ...
        render_toggle_card(
            appearance,
            ToggleCardSpec {
                title: tr("onboarding.customize.code_review"),
                is_expanded: is_selected,
